...
public class EmployeeClientFallback implements EmployeeClient {
    ...
    @Override
    public void validateEmployees(List<Long> employeeIds) {
        log.error("Employee service is down. Cannot validate employees: {}", employeeIds);
        throw new RuntimeException("Employee service unavailable. Try again later.");
    }
